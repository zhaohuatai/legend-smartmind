 ...
 */
public class PythonTool2 implements BiFunction<PythonTool2.PythonRequest, ToolContext, String> {
	...
	public static final String DESCRIPTION = """
			...
			""";
	private static final Logger log = LoggerFactory.getLogger(PythonTool2.class);
	...
	public static ToolCallback createPythonToolCallback(String description) {
		return FunctionToolCallback.builder("python_tool", new PythonTool2())
	...
	public String apply(PythonRequest request, ToolContext toolContext) {
		...
		try (Context context = Context.newBuilder("python")
		        .engine(engine)
		        .option("python.PythonPath", "D:\\bin\\anaconda3\\Lib\\site-packages")  // 添加这一行
