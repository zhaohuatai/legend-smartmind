...
@Mapper
public interface ClassActivitySubmitMapper extends BaseMapper<ClassActivitySubmit>{
	List<ClassActivitySubmit> selectByActivityId(@Param("activityId") Long activityId);
}
