 ...
 */
  ...
  // ============================================
  const SLIDES_CONFIG = {
    // 从 index2.html 拆分的 56 个页面 (01.md - 55.md)，00.md 为全局配置已合并到配置功能中
    slides: Array.from({length: 55}, (_, i) => `slides/${String(i + 1).padStart(2, '0')}.md`)
  };
  ...
  function loadAllSlidesSync() {
    ...
    if (sourceEl) {
      sourceEl.value = fullContent;
      console.log("--targetTextArea----", sourceEl.value);
    }
