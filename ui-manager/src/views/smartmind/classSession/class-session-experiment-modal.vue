  ...
  >
    <div class="resource-modal">
      ...
      <div class="modal-section table-section">
        ...
        >
          <template #bodyCell="{ record, column }">
            <template v-if="column.dataIndex === 'itemScore'">
              <a-input-number
      ...
      <div class="modal-section action-section">
        ...
        <span class="score-summary">当前总分: {{ currentTotalScore }} / {{ totalScore || 100 }}</span>
      </div>
    </div>
  </a-modal>
</template>
...
import { ClockCircleOutlined, ExperimentOutlined, TrophyOutlined, ThunderboltOutlined } from '@ant-design/icons-vue';
...
async function loadResources() {
  ...
  try {
    ...
    const res = await experimentGuideApi.loadByCourseAndUnitCodes({ courseId: props.courseId, unitCodes });
