...
import { ClockCircleOutlined, CommentOutlined, TrophyOutlined, ThunderboltOutlined } from '@ant-design/icons-vue';
...
async function loadResources() {
  ...
  try {
    ...
    const res = await discussionTopicApi.loadByCourseAndUnitCodes({ courseId: props.courseId, unitCodes });
