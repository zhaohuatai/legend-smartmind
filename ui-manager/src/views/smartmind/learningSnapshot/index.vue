  ...
  <div>
    <a-form class="smart-query-form">
      <a-row class="smart-query-form-row">
        ...
        <a-form-item label="快照时间" class="smart-query-form-item">
          <a-date-picker v-model:value="queryForm.snapshotTime" placeholder="请选择快照时间" style="width: 200px" />
        </a-form-item>
    ...
    <LearningSnapshotFormModal ref="formModalRef" @reloadList="queryData" />
  </div>
</template>
...
<script setup>
  ...
  import LearningSnapshotFormModal from './learningSnapshot-form-modal.vue';
  ...
  async function queryData() {
    try {
      ...
      let res = await learningSnapshotApi.queryPage(queryForm);
  ...
  async function toDelete(record) {
    try {
      await learningSnapshotApi.delete(record.id);
