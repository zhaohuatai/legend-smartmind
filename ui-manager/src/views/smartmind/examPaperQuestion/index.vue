  ...
  <div>
    <a-form class="smart-query-form">
      <a-row class="smart-query-form-row">
        <a-form-item label="试卷ID" class="smart-query-form-item">
          <a-input style="width: 200px" v-model:value="queryForm.paperId" placeholder="请输入试卷ID" />
        </a-form-item>
    ...
    <ExamPaperQuestionFormModal ref="formModalRef" @reloadList="queryData" />
  </div>
</template>
...
<script setup>
  ...
  import ExamPaperQuestionFormModal from './examPaperQuestion-form-modal.vue';
  ...
  async function queryData() {
    try {
      ...
      let res = await examPaperQuestionApi.queryPage(queryForm);
  ...
  async function toDelete(record) {
    try {
      await examPaperQuestionApi.delete(record.id);
