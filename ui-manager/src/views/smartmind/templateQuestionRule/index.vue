  ...
  <div>
    <a-form class="smart-query-form">
      <a-row class="smart-query-form-row">
        <a-form-item label="模板ID" class="smart-query-form-item">
          <a-input style="width: 200px" v-model:value="queryForm.templateId" placeholder="请输入模板ID" />
        </a-form-item>
    ...
    <TemplateQuestionRuleFormModal ref="formModalRef" @reloadList="queryData" />
  </div>
</template>
...
<script setup>
  ...
  import TemplateQuestionRuleFormModal from './templateQuestionRule-form-modal.vue';
  ...
  async function queryData() {
    try {
      ...
      let res = await templateQuestionRuleApi.queryPage(queryForm);
  ...
  async function toDelete(record) {
    try {
      await templateQuestionRuleApi.delete(record.id);
