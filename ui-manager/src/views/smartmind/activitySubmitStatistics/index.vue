<template>
  <div>
    ...
    <ActivitySubmitStatisticsFormModal ref="formModalRef" @reloadList="queryData" />
  </div>
</template>
...
<script setup>
  ...
  import ActivitySubmitStatisticsFormModal from './activitySubmitStatistics-form-modal.vue';
  ...
  async function queryData() {
    try {
      ...
      let res = await activitySubmitStatisticsApi.queryPage(queryForm);
  ...
  async function toDelete(record) {
    try {
      await activitySubmitStatisticsApi.delete(record.id);
