<template>
  <div>
    ...
    <ClassActivityQuestionFormModal ref="formModalRef" @reloadList="queryData" />
  </div>
</template>
...
<script setup>
  ...
  import ClassActivityQuestionFormModal from './classActivityQuestion-form-modal.vue';
  ...
  async function queryData() {
    try {
      ...
      let res = await classActivityQuestionApi.queryPage(queryForm);
  ...
  async function toDelete(record) {
    try {
      await classActivityQuestionApi.delete(record.id);
