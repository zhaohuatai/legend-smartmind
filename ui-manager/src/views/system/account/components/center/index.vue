        ...
        <a-col flex="350px">
          <a-form ref="formRef" :model="form" :rules="rules" layout="vertical">
            <a-form-item label="登录账号" name="account">
              <a-input class="form-item" v-model:value.trim="form.account" placeholder="请输入登录账号" disabled />
            </a-form-item>
            ...
            <a-form-item label="员工名称" name="perName">
              <a-input class="form-item" v-model:value.trim="form.perName" placeholder="请输入员工名称" />
            </a-form-item>
