    ...
    <a-form class="smart-query-form">
      <a-row class="smart-query-form-row">
        <a-form-item label="账号" class="smart-query-form-item">
          <a-input style="width: 200px" v-model:value="queryForm.account" placeholder="请输入账号" />
        </a-form-item>
        <a-form-item label="姓名" class="smart-query-form-item">
          <a-input style="width: 200px" v-model:value="queryForm.perName" placeholder="请输入姓名" />
        </a-form-item>
        <a-form-item label="手机号" class="smart-query-form-item">
          <a-input style="width: 200px" v-model:value="queryForm.phone" placeholder="请输入手机号" />
        </a-form-item>
...
import md5 from 'js-md5';
  ...
  async function queryData() {
    try {
      ...
      let res = await userApi.queryPage(queryForm);
  ...
  async function submitResetPwd() {
      ...
      try {
          ...
          const encryptedPassword = md5(salt + newPassword.value);
          await userApi.resetPassword(currentUserId.value, encryptedPassword);
